...
示例:
    uv run python eval/rq3_eval_inferred_signatures.py out/pcstubgen/psycopg2.toml
    uv run python eval/rq3_eval_inferred_signatures.py out/pcstubgen/psycopg2.toml --manual-stub-root ./stubs
    uv run python eval/rq3_eval_inferred_signatures.py out/pcstubgen/psycopg2.toml --sample-size 200 --sample-seed 0
"""
