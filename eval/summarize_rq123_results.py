...
示例:
    uv run python eval/summarize_rq123_results.py out/pcstubgen/ujson.toml
    uv run python eval/summarize_rq123_results.py out/pcstubgen/ujson.toml --evaluation-csv out/pcstubgen/ujson_eval_20260510_120000.csv
"""
