...
示例:
    uv run python eval/summarize_rq4_benchmark_csvs.py eval/benchmark/*.csv
    uv run python eval/summarize_rq4_benchmark_csvs.py eval/benchmark/*.csv --output out/benchmark_summary
"""
