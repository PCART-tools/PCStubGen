...
def _collect_module_entries(
    ...
    entries.extend(_collect_current_module_entries(module, renderer))

    for sub_module in module.sub_modules:
        entries.extend(_collect_module_entries(sub_module, renderer))
...
def _build_entry(
    ...
    """构造单条 TOML 记录。"""
    entry: dict[str, str] = {"module_name": module_name}
...
class TomlWriter:
    ...
    def write(
        ...
        entries = _collect_module_entries(module, renderer)
